...
cli-tests:
	cd cli && cargo run --all-features -- --cert-type PK12 --cert ../etc/docker-cassandra/secrets/keystore.p12:cassandra --ca-file ../etc/docker-cassandra/secrets/keystore.cer.pem -h localhost test-connection
